...
//        printf("%s\n", line);
   ...
   double finalAverage = 0;
    ...
    midterm1Average = midterm1Average / (double) line_count;
    midterm2Average = midterm2Average / (double) line_count;
    finalAverage = finalAverage / (double) line_count;
    fprintf(outFile, "\n");
    fprintf(outFile, "Averages: midterm1 %.2f, midterm2 %.2f, final %.2f", midterm1Average, midterm2Average,
    finalAverage);
   return 0;
