...
router
  ...
  .delete(async (req, res) => {
    ...
    try {
      const deletedEvent = await eventData.remove(eventId);
  ...
  .put(async (req, res) => {
    ...
    //insert the event
    try {
      const newEvent = await eventData.update(eventId, eventParams.eventName, eventParams.eventDescription, eventParams.eventLocation, eventParams.contactEmail, eventParams.maxCapacity, eventParams.priceOfAdmission, eventParams.eventDate, eventParams.startTime, eventParams.endTime, eventParams.publicEvent);
