...
public class RegisterService extends Service {
    ...
    public int onStartCommand(@NonNull Intent intent, int flags, final int startId) {
        ...
        cancelIntent.setAction(RegisterService.ACTION_CANCEL);

        PendingIntent cancelPendingIntent = PendingIntent.getService(this, 0, cancelIntent, PendingIntent.FLAG_IMMUTABLE);

        Notification.Action cancelAction = new Notification.Action.Builder(icon, getText(R.string.register_cancel_button_label), cancelPendingIntent).build();
            ...
            try {
                ...
                mainLoop.post(() -> {
                    ...
                    if (registerResponse != null && !(registerResponse instanceof ErrorResponse)) {
                        ...
                        notificationBuilder.setContentText(getText(R.string.registered_notification_message));
