...
public class ViewPeersActivity extends FragmentActivity implements TextAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO create the view model and query for a list of all peers - code written by msuresh
        PeersViewModel peersViewModel = new ViewModelProvider(this).get(PeersViewModel.class);


        // TODO observer for list of peers updates the peer adapter - code written by msuresh
        peersViewModel.fetchAllPeers().observe(this,
                peers -> {
