...
/*
 * TODO add annotations (NB insert should ignore conflicts, for upsert) - code written by msuresh
 *
...
public abstract class PeerDao {
    ...
    @Transaction
    /**
     * TODO Add a peer record if it does not already exist; - code written by msuresh
